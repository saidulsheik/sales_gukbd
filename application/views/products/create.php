						...
						<div class="col-sm-4 col-md-4">
							...
							<select class="form-control select_group" id="category_id" name="category_id">
								...
								<?php foreach ($category_id as $k => $v): ?>
								  <option value="<?php echo $v['id'] ?>" <?php echo set_select('category_id', $v['id']);?> ><?php echo $v['category_name'] ?></option>
								<?php endforeach ?>
							</select>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
							  ...
							  <textarea type="text" class="form-control" id="description" name="description" value="<?php echo set_value('description'); ?>" placeholder="Enter description" autocomplete="off"> </textarea>
