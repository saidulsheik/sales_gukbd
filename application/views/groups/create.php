                    ...
                    <tbody>
                      ...
                      <tr>
						...
						<tr>
							...
							<td><input type="checkbox" name="permission[]" id="permission" value="createProductReceive" class="minimal"></td>
							<td><input type="checkbox" name="permission[]" id="permission" value="updateProductReceive" class="minimal"></td>
							<td><input type="checkbox" name="permission[]" id="permission" value="viewProductReceive" class="minimal"></td>
							<td><input type="checkbox" name="permission[]" id="permission" value="deleteProductReceive" class="minimal"></td>
						</tr>
						<!-- Product Receive End-->
						...
						<tr>
							<td>Product Price</td>
							<td><input type="checkbox" name="permission[]" id="permission" value="createProductPrice" class="minimal"></td>
							<td><input type="checkbox" name="permission[]" id="permission" value="updateProductPrice" class="minimal"></td>
							<td><input type="checkbox" name="permission[]" id="permission" value="viewProductPrice" class="minimal"></td>
							<td><input type="checkbox" name="permission[]" id="permission" value="deleteProductPrice" class="minimal"></td>
						</tr>
						<!-- Product Receive End-->
						...
						<tr>
							<td>Demand</td>
							<td><input type="checkbox" name="permission[]" id="permission" value="createDemand" class="minimal"></td>
							<td><input type="checkbox" name="permission[]" id="permission" value="updateDemand" class="minimal"></td>
							<td><input type="checkbox" name="permission[]" id="permission" value="viewDemand" class="minimal"></td>
							<td><input type="checkbox" name="permission[]" id="permission" value="deleteDemand" class="minimal"></td>
						</tr>
						...
						<tr>
							...
							<td><input type="checkbox" name="permission[]" id="permission" value="createDemandConfiguration" class="minimal"></td>
							<td><input type="checkbox" name="permission[]" id="permission" value="updateDemandConfiguration" class="minimal"></td>
							<td><input type="checkbox" name="permission[]" id="permission" value="viewDemandConfiguration" class="minimal"></td>
							<td><input type="checkbox" name="permission[]" id="permission" value="deleteDemandConfiguration" class="minimal"></td>
						</tr>
						<!-- Demand Configuration End-->
