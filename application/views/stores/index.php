      ...
      <form role="form" action="<?php echo base_url('stores/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="store_code" name="store_code" placeholder="Enter store code" autocomplete="off">
          </div>
		  ...
		  <div class="form-group">
            ...
            <input type="text" class="form-control" id="store_contact" name="store_contact" placeholder="Enter store contact no." autocomplete="off">
          </div>
		  ...
		  <div class="form-group">
		   ...
		   <div class="form-group">
            <label for="store_address">Store Address</label>
			 <textarea class="form-control" class="form-control" id="store_address" name="store_address" placeholder="Enter store address">	</textarea>
          </div>
      ...
      <form role="form" action="<?php echo base_url('stores/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          <div id="messages"></div>
			...
			<input type="hidden" class="form-control" id="old_store_code" name="old_store_code">
			<input type="hidden" class="form-control" id="old_store_name" name="old_store_name">
		
		 <div class="form-group">
            <label for="edit_store_code">Store Code</label>
            <input type="text" class="form-control" id="edit_store_code" name="edit_store_code" placeholder="Enter Store Code" autocomplete="off">
          </div>
		  ...
		  <div class="form-group">
            <label for="edit_store_contact">Store Contact</label>
            <input type="text" class="form-control" id="edit_store_contact" name="edit_store_contact" placeholder="Enter Store Contact no." autocomplete="off">
          </div>
		  
		  <div class="form-group">
            <label for="edit_store_email">Store Email</label>
            <input type="email" class="form-control" id="edit_store_email" name="edit_store_email" placeholder="Enter Store Email Address" autocomplete="off">
          </div>
		   <div class="form-group">
            <label for="edit_store_address">Store Address</label>
			 <textarea class="form-control" class="form-control" id="edit_store_address" name="edit_store_address" placeholder="Enter Store Address">	</textarea>
          </div>
...
{ 
  $.ajax({
    ...
    dataType: 'json',
    success:function(response) {
      $("#old_store_code").val(response.store_code);
      $("#old_store_name").val(response.store_name);
      $("#edit_store_code").val(response.store_code);
